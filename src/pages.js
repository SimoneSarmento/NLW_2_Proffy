...
function savedRegistration(req, res) {
    return res.render("./saved-registration.html")
}
...
async function pageStudy(req, res) {
    ...
    const query = `
        ...
        WHERE  EXISTS (
            ...
            AND class_schedule.weekday = "${filters.weeday}"
    ...
    //importante para a pratica de programação
    try {
...
module.exports = { pageLanding, pageStudy, pageGiveClasses, saveClasses, savedRegistration }
